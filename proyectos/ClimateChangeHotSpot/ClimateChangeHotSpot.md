---
layout: page
permalink: /proyectos/ClimateChangeHotSpot/
---
<div class="conteudo">
  <!-- Apresentar os objetivos -->
  <section id="objetivos">
    <h2>Objetivos del Proyecto</h2>
    <p>{{ site.data.ClimateChangeHotSpot.objetivos | markdownify }}</p>
  </section>

  <!-- Apresentar a metodologia -->
  <section id="metodologia">
    <h2>Metodología</h2>
    <p>{{ site.data.ClimateChangeHotSpot.metodologia | markdownify }}</p>
  </section>
  ...
  <section id="publicaciones">
    <h2>Publicaciones</h2>
    <ul>
      {% for publicacion in site.data.ClimateChangeHotSpot.publicaciones %}
        <li>
  ...
  <section id="noticias">
    <h2>Noticias</h2>
    {% for noticia in site.data.ClimateChangeHotSpot.noticias %}
    <div class="noticia">
      <strong>
  ...
  <section id="equipe">
    ...
    <div class="equipe-container">
      {% for membro in site.data.ClimateChangeHotSpot.equipo %}
        <div class="membro">
